...
- This ansible project applies changes to your local host system. However there are some optional playbooks I made that are designed to apply on the guest machines.
